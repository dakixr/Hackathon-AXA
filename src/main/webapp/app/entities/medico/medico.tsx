            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('apellidos')}>
                  Apellidos <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('numero_colegiado')}>
                  Numero Colegiado <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('telefono_contacto')}>
                ...
                <th className="hand" onClick={sort('centro_sanitario')}>
                  Centro Sanitario <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {mEDICOList.map((mEDICO, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{mEDICO.telefono_contacto}</td>
                  <td>{mEDICO.especialidad}</td>
                  <td>{mEDICO.centro_sanitario}</td>
