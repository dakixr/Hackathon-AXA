...
import static es.axa.hackathon.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import es.axa.hackathon.config.Constants;
import es.axa.hackathon.domain.PersistentToken;
import es.axa.hackathon.domain.User;
import es.axa.hackathon.repository.AuthorityRepository;
import es.axa.hackathon.repository.PersistentTokenRepository;
import es.axa.hackathon.repository.UserRepository;
import es.axa.hackathon.security.AuthoritiesConstants;
import es.axa.hackathon.service.UserService;
import es.axa.hackathon.service.dto.AdminUserDTO;
import es.axa.hackathon.service.dto.PasswordChangeDTO;
import es.axa.hackathon.service.dto.UserDTO;
import es.axa.hackathon.web.rest.vm.KeyAndPasswordVM;
import es.axa.hackathon.web.rest.vm.ManagedUserVM;
